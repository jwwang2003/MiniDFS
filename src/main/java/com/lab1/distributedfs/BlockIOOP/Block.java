...
public class Block {
    ...
    public static final Pattern pattern = Pattern.compile("replica(\\d+)_([^_]+)_block(\\d+)" + Constants.BLOCK_FILETYPE);
    ...
    public String getFileName() {
        return DataNode.getBlockName(this.replica, this.filename, this.blockID) + Constants.BLOCK_FILETYPE;
    }
